...
import artur.practicing.social.service.ProfileService;
...
public class ProfileController {
    ...
    public User changeSubscription(
            @AuthenticationPrincipal DefaultOidcUser subscriber,
            @PathVariable("channelId") User channel
    ) {
        if (subscriber.getName().equals(channel.getName())) {
            return channel;
        } else {
    ...
    public UserSubscription changeSubscriptionStatus(
            @AuthenticationPrincipal DefaultOidcUser channel,
